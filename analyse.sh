...
./run_snake.sh OPUS-2017-Obesity-CNVsCalling "$DATADIR" /ngsnake/Snakefile.copy_number_variants /ngsnake/config.yaml call_cnvs
./run_snake.sh OPUS-2017-Obesity-CNVsCalling "$DATADIR" /ngsnake/Snakefile.copy_number_variants /ngsnake/config.yaml call_cnmops_cvsc
